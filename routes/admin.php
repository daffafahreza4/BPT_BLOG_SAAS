...
Route::middleware(['auth', 'can:admin-login'])->name('admin.')->prefix('/admin')->group(function () {
    ...
    Route::middleware(['can:admin-only'])->group(function () {
        ...
        Route::get('/proofs', [App\Http\Controllers\Admin\UpgradeProofController::class, 'index'])->name('proofs.index');
        Route::get('/proofs/{id}', [App\Http\Controllers\Admin\UpgradeProofController::class, 'show'])->name('proofs.show');
        Route::post('/proofs/{id}/approve', [App\Http\Controllers\Admin\UpgradeProofController::class, 'approve'])->name('proofs.approve');
        Route::post('/proofs/{id}/cancel', [App\Http\Controllers\Admin\UpgradeProofController::class, 'cancel'])->name('proofs.cancel');
    });
});

...
Route::get('/memberships', [App\Http\Controllers\UserMembershipController::class, 'index'])->name('memberships');
Route::get('/upload-proof/{membership}', [App\Http\Controllers\UploadProofController::class, 'show'])->name('upload-proof.show');
Route::post('/upload-proof/{membership}', [App\Http\Controllers\UploadProofController::class, 'store'])->name('upload-proof.store');

        ...
        <main class="w-full flex-grow p-6">
            ...
            <div class="w-full mt-12">
                ...
                <div class="mb-1">
                    ...
                    <select class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="selectType" name="membership_id">
                        @foreach ($memberships as $category)
                        <option value="{{ $category->id }}"  {{ $post->membership_id == $category->id ? 'selected' : '' }} >{{ $category->role }}</option>
                        @endforeach
                      </select>
                    </div>
                {{--  --}}
